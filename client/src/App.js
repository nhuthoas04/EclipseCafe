            ...
            <div className="App">
              ...
              <main className="main-content">
                <Routes>
                  ...
                  <Route
                    path="/blog/ca-phe-arabica-cao-nguyen"
                    element={<CaPheArabicaCaoNguyen />}
                  />
                  <Route
                    path="/blog/ca-phe-sua-da-linh-hon-viet"
                    element={<CaPheSuaDaLinhHonViet />}
                  />
                  <Route
                    path="/blog/nghe-thuat-pha-tra-oolong"
                    element={<NgheThuatPhaTraOolong />}
                  />
                  <Route
                    path="/blog/tra-sen-vang-huong-vi-truyen-thong"
                    element={<TraSenVangHuongViTruyenThong />}
                  />
                  <Route
                    path="/blog/eclipse-hanh-trinh-ca-phe-viet"
                    element={<EclipseHanhTrinhCaPheViet />}
                  />
                  <Route
                    path="/blog/mua-dong-am-ap-eclipse"
                    element={<MuaDongAmApEclipse />}
                  />
